...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "wholesale order odogwu", "chatham grocery contact",
  ],
  openGraph: {
    title: "Contact Us | Odogwu African Shop",
        ...
        <section className="relative h-80 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            ...
            <p className="text-[#FAF7F0]/90 text-lg max-w-xl">
              Questions about products, delivery, or wholesale orders? Reach out and we&apos;ll get back to you promptly.
            </p>
          </div>
        </section>
...
<br />
                <a href="tel:+447349133791" className="text-[#6B7280] hover:text-[#1B4332] transition-colors">+44 7349133791</a>
              ...
              <div className="bg-white rounded-2xl p-8 border border-[#E5E2D9] hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-lg font-bold text-[#1B4332] mb-2" style={{ fontFamily: "var(--font-playfair)" }}>Email</h3>
                <a href="mailto:info@odogwuafricanshop.co.uk" className="text-[#6B7280] hover:text-[#1B4332] transition-colors">info@odogwuafricanshop.co.uk</a>
                <p className="text-sm text-[#6B7280] mt-1">We reply within 24 hours</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-[#E5E2D9] hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-lg font-bold text-[#1B4332] mb-2" style={{ fontFamily: "var(--font-playfair)" }}>Visit Us</h3>
                <p className="text-[#6B7280]">23 Railway St, Chatham<br />ME4 4HU, United Kingdom</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-[#E5E2D9] mb-16 max-w-md">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-bold text-[#1B4332]" style={{ fontFamily: "var(--font-playfair)" }}>Opening Hours</h3>
              </div>
              <div className="space-y-3">
                {[
                  ...
                  <div key={day} className="flex justify-between items-center py-2 border-b border-[#E5E2D9] last:border-0">
                    <span className="text-[#1C1C1C] font-medium">{day}</span>
                    <span className={`text-sm ${closed ? "text-[#C0392B]" : "text-[#6B7280]"}`}>{hours}</span>
                  </div>
                ))}
              </div>
              <p className="text-sm text-[#6B7280] mt-4">Pickup ends at 7:30pm daily</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold text-[#1B4332] mb-2" style={{ fontFamily: "var(--font-playfair)" }}>Send Us a Message</h2>
                <p className="text-[#6B7280] mb-8">Fill out the form below and we&apos;ll get back to you as soon as possible.</p>
                <ContactForm />
              </div>
